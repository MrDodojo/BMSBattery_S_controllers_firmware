...
#define PHASE_CURRENT_MAX_VALUE 600L
...
#define LEVEL_4 85
#define LEVEL_5 100
#define MORSE_TIME_1 90
#define MORSE_TIME_2 40
#define MORSE_TIME_3 15
...
#define ACA 5250
#define EEPROM_INIT_MAGIC_BYTE 189 // makes sure (chance of fail 1/255) eeprom is invalidated after flashing new config
