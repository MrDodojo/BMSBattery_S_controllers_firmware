...
#define ACA_EXPERIMENTAL_LOW (USE_ALTERNATE_WAVETABLE_C | USE_ALTERNATE_WAVETABLE | AVOID_MOTOR_CYCLES_JITTER)
#define ACA_EXPERIMENTAL_HIGH (THROTTLE_UNRESTRICTED | PWM_AUTO_OFF) 
